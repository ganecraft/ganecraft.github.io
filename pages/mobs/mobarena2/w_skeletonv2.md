...
![image](/assets/img/mobs/mobarena2/m2wskeleton2.png){: class="mob-image" }

<div class="mob-div-description-flex">
	<div class="mob-div-description">
		<h2>Wither skeleton v2</h2>
		<br>
		...
		<h3><u>Statok</u>:</h3>
		<br>
		<p>Életerő: <span class="mob-highlight">30</span></p>
		...
		<p>Abszolút védelem: <span class="mob-highlight">5</span></p>
		...
		<p>Pajzs átütés: <span class="mob-highlight">5</span> %</p>
...
<table class="mob-drops">
	...
	<tr>
		<td>
			...
			<p>Pénz: <span class="mob-highlight">25-50</span></p>
		</td>
		<td>
