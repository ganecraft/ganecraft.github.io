...
![image](/assets/img/mobs/mobarena2/m2wskeleton1.png){: class="mob-image" }

<div class="mob-div-description-flex">
	<div class="mob-div-description">
		<h2>Wither skeleton v1</h2>
		<br>
		...
		<p>Védelem: <span class="mob-highlight">30</span> % (<span class="mob-highlight">15</span> armor)</p>
		<h3><u>Támadóérték</u>:</h3>
		<br>
		<p>Sebzés: <span class="mob-highlight">10</span></p>
		...
		<h3><u>Védelem</u>:</h3>
		<br>
		<p>Krit ellenállás: <span class="mob-highlight">30</span> %</p>
...
<table class="mob-drops">
	...
	<tr>
		<td>
			...
			<p>Exp: <span class="mob-highlight">3</span></p>
			<p>Pénz: <span class="mob-highlight">20-35</span></p>
		</td>
		<td>
...
<script>
	itemDrops = ["Csont", "Szén", "Aranyalma"];
</script>
