...
![image](/assets/img/mobs/mobarena2/m2husk1.png){: class="mob-image" }
...
<div class="mob-div-description-flex">
	<div class="mob-div-description">
		...
		<p>Tűz ellenállás: <span class="mob-highlight">40</span> %</p>
		<p>Zuhanás ellenállás: <span class="mob-highlight">55</span> %</p>
		<br>
...
<table class="mob-drops">
	...
	<tr>
		<td>
			...
			<p>Pénz: <span class="mob-highlight">15-35</span></p>
		</td>
		<td>
...
<script>
	itemDrops = ["Réz", "Vas", "Répa", "Krumpli", "Rohadt hús", "Aranyalma"];
</script>
